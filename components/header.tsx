...
<section className="flex w-full flex-nowrap items-center justify-between bg-[#e3f2fd] py-2 text-neutral-500 hover:text-neutral-700 focus:text-neutral-700 dark:bg-[#93b9d3] lg:flex-wrap lg:justify-start lg:py-4">


    <Container>
      <h2 className="text-2xl md:text-4xl text-center font-bold tracking-tight md:tracking-tighter leading-tight mb-20 mt-8">
